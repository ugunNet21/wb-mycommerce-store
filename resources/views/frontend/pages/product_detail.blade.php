...
@endsection
@section('title','Product Detail Net IT')
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	You need to <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Masuk</a> Atau <a style="color:blue" href="{{route('register.form')}}">Daftar</a>
