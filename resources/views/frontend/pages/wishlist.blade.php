					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">+ KE KERANJANG</th> 
								<th class="text-center"><i class="ti-trash remove-icon"></i>HAPUS</th>
							</tr>
						</thead>
						<tbody>
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>+ Ke Keranjang</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Tidak ada Favorite. <a href="{{route('product-grids')}}" style="color:blue;">Lanjut Belanja</a>
