            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-maps"></i> <a href="{{route('location')}}">Detek Lokasi</a></li>
                            ...
                            @else
                                <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">Login /</a> <a href="{{route('register.form')}}">Daftar</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='service' ? 'active' : ''}}"><a href="http://netitcomp.com" target="_blank">Service</a></li>
                                            <li class="{{Request::path()=='sales' ? 'active' : ''}}"><a href="http://tokko.io/netitcomp" target="_blank">Other Shop</a></li>
