 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        <?php else: ?>
          <h6 class="text-center">Tida ada aktivitas review</h6>
        <?php endif; ?>
      </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/backend/review/index.blade.php ENDPATH**/ ?>