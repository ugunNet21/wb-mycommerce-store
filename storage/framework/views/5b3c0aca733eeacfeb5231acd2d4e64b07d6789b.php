<?php $__env->startSection('title','NET IT HOME'); ?>
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item <?php echo e((($key==0)? 'active' : '')); ?>">
                    ...
                    <div class="carousel-caption d-none d-md-block text-left">
                        ...
                        <a class="btn btn-lg ws-btn wow fadeInUpBig" href="<?php echo e(route('product-grids')); ?>" role="button">Belanja sekarang<i class="far fa-arrow-alt-circle-right"></i></i></a>
                    </div>
                </div>  
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
        </div>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-price">
                                                ...
                                                ?>
                                                <span>Rp <?php echo e(number_format($after_discount,3)); ?></span>
                                                <del style="padding-left:4%;">Rp <?php echo e(number_format($product->price,3)); ?></del>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php $__currentLoopData = $product_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->title); ?></a></h3>
                                <div class="product-price">
                                    <span class="old">Rp <?php echo e(number_format($product->price,3)); ?></span>
                                    <?php 
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    ?>
                                    <span>Rp <?php echo e(number_format($after_discount,3)); ?></span>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">Rp <?php echo e(number_format($product->discount,2)); ?></p>
                                    </div>
                                </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        <?php
                                            $after_discount=($product->price-($product->price*$product->discount)/100);
                                        ?>
                                        <h3><small><del class="text-muted">Rp <?php echo e(number_format($product->price,3)); ?></del></small>    Rp <?php echo e(number_format($after_discount,3)); ?>  </h3>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/frontend/index.blade.php ENDPATH**/ ?>