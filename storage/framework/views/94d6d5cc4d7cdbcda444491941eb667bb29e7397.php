<?php $__env->startSection('main-content'); ?>
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo e(route('category.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Kategori</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <?php else: ?>
          <h6 class="text-center">Tidak ada kategori!!! Buat kategori</h6>
        <?php endif; ?>
      </div>
    </div>
</div>
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    ...
                    text: "Setelah dihapus, tidak dapat dikembalikan lagi!",
                    icon: "Perhatian",
                    buttons: true,
                    dangerMode: true,
                })
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/backend/category/index.blade.php ENDPATH**/ ?>