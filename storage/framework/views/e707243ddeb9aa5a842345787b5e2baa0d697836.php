<?php $__env->startSection('title','About NET IT'); ?>
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							?>
							<h3>Welcome To <span>NET IT Computer</span></h3>
					...
					<div class="col-lg-6 col-12">
						<div class="about-img overlay">
							<div class="button">
								<a href="https://www.youtube.com/watch?v=qVmT5ZjDfE8" class="video video-popup mfp-iframe"><i class="fa fa-play"></i></a>
							</div> 
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/frontend/pages/about-us.blade.php ENDPATH**/ ?>