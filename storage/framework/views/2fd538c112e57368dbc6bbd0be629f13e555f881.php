<header class="header shop">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-maps"></i> <a href="<?php echo e(route('location')); ?>">Detek Lokasi</a></li>
                            
                            <?php if(auth()->guard()->check()): ?> 
                                <?php if(Auth::user()->role=='admin'): ?>
                                    <li><i class="ti-user"></i> <a href="<?php echo e(route('admin')); ?>"  target="_blank">Dashboard</a></li>
                                <?php else: ?> 
                                    <li><i class="ti-user"></i> <a href="<?php echo e(route('user')); ?>"  target="_blank">Profile</a></li>
                                <?php endif; ?>
                                <li><i class="ti-power-off"></i> <a href="<?php echo e(route('user.logout')); ?>">Logout</a></li>

                            <?php else: ?>
                                <li><i class="ti-power-off"></i><a href="<?php echo e(route('login.form')); ?>">Login /</a> <a href="<?php echo e(route('register.form')); ?>">Daftar</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <!-- End Top Right -->
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="<?php echo e(Request::path()=='service' ? 'active' : ''); ?>"><a href="http://netitcomp.com" target="_blank">Service</a></li>
                                            <li class="<?php echo e(Request::path()=='sales' ? 'active' : ''); ?>"><a href="http://tokko.io/netitcomp" target="_blank">Other Shop</a></li>
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>