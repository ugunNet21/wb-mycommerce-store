...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Gambaran</label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Poto <span class="text-danger">*</span></label>
          <div class="input-group">
              <span class="input-group-btn">
                  <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary">
                  <i class="fa fa-picture-o"></i> Masukan
                  </a>
              </span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/backend/product/create.blade.php ENDPATH**/ ?>