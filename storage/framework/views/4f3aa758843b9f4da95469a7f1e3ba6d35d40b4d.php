 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                <tr>
                    ...
                    <td>
                        <?php if($coupon->type=='fixed'): ?>
                            Rp. <?php echo e(number_format($coupon->value,2)); ?>
        ...
        <?php else: ?>
          <h6 class="text-center">Tidak ada kupon, silahkan buat kupon!</h6>
        <?php endif; ?>
      </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/backend/coupon/index.blade.php ENDPATH**/ ?>