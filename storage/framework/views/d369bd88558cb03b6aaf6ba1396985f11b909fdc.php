...
<?php $__env->startSection('title','Product Detail Net IT'); ?>
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<?php endif; ?>
												<p class="availability">Stok : <?php if($product_detail->stock>0): ?><span class="badge badge-success"><?php echo e($product_detail->stock); ?></span><?php else: ?> <span class="badge badge-danger"><?php echo e($product_detail->stock); ?></span>  <?php endif; ?></p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
...
unset($__errorArgs, $__bag); ?>
																...
																<p class="text-center p-5">
																	You need to <a href="<?php echo e(route('login.form')); ?>" style="color:rgb(54, 54, 204)">Masuk</a> Atau <a style="color:blue" href="<?php echo e(route('register.form')); ?>">Daftar</a>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <div class="default-social">
                                <h4 class="share-now">Bagi:</h4>
                                <ul>
                                    <li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
                                    <li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
                                    <li><a class="youtube" href="https://www.youtube.com/channel/UC5emSMgxyABEk-0dD2GnbvA"><i class="fa fa-pinterest-p"></i></a></li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01. Advance-Ecommerce-in-laravel-7-pending\resources\views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>