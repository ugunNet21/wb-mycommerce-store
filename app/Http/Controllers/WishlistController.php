...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request){
        ...
        if($already_wishlist) {
            request()->session()->flash('error','produk sudah ada');
            return back();
        }else{
        ...
        request()->session()->flash('sukses','produk ditambhkan ke favorit');
        return back();       
    }  
    ...
    public function wishlistDelete(Request $request){
        ...
        if ($wishlist) {
            $wishlist->delete();
            request()->session()->flash('sukses','favorit dihapus');
            return back();  
        }
        request()->session()->flash('eror','Error please try again');
        return back();       
    }     
}
