...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('sukses','Pengirim berhasil dibuat');
        }
        else{
    ...
    public function edit($id)
    {
        ...
        if(!$shipping){
            request()->session()->flash('error','Pengirim tidak ditemukan');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','pengiriman diperbaharui');
        }
        else{
    ...
    public function destroy($id)
    {
        ...
        if($shipping){
            ...
            if($status){
                request()->session()->flash('sukses','Pengiriman dihapus');
            }
            else{
                request()->session()->flash('error','Error, Please try again');
            }
