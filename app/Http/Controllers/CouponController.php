...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('Berhasil','Kupon berhasil ditambahkan');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Kupon diganti');
        }
        else{
            request()->session()->flash('error','Coba lagi!!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($coupon){
            ...
            if($status){
                request()->session()->flash('Sukses','Kupon dihapus');
            }
            else{
    ...
    public function couponStore(Request $request){
        ...
        // dd($coupon);
        if(!$coupon){
            request()->session()->flash('error','Kode kupon salah');
            return back();
        }
        if($coupon){
            ...
            request()->session()->flash('success','Kupon ditambhakan');
            return redirect()->back();
        }
    }
}
